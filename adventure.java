...
public class adventure {
  ...
  public static void main (String args[]) {
    ...
    /* choose your own adventure that needs at least 4 choices per path. one input needs to be an integer. need while loops to recieve valid input 
     * 
    ...
    */
    ...
    if (choice == 1) {
      print("You start walking toward the forest lugging your heavy backpack behind you. You keep walking and you walk another " + random(10) + " km into the forest until you finally find a river. The white water rushing over the rocks assures you that it is probably safe to drink. You bend down and cup your hands preparing to scoop some water when you hear a siren in the distance. You raise your head and try to find where the sound came from. Do you 1, stay and try to find food while making your way back out of the forest, or 2, try to investigate the sound. ");
