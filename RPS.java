...
public class RPS {
    ...
    public static void main(String args[]) {
        ...
        if (difficulty == 1) {
            ...
            while (!playerChoice1.equals("Rock") && !playerChoice1.equals("Paper")
                    && !playerChoice1.equals("Scissors")) {
                println("I need either Rock, Paper, or Scissors.");
                playerChoice1 = keyboard.nextLine();
            }
            if (playerChoice1.equals("Rock")) {
                println("You won. Pog. You chose " + playerChoice1 + ", and the computer chose Scissors");
            } else if (playerChoice1.equals("Paper")) {
                println("You won. Pog. You chose " + playerChoice1 + ", and the computer chose Rock");
            } else if (playerChoice1.equals("Scissors")) {
                println("You won. Pog. You chose " + playerChoice1 + ", and the computer chose Paper");
            }
            ...
            if (playerChoice.equals("Rock") && RPS[comChoice].equals("Paper")) {
                println("You lost. L + Bozo. You chose " + playerChoice + ", and the computer chose "
                + RPS[comChoice]);
            } else if (playerChoice.equals("Rock") && RPS[comChoice].equals("Scissors")) {
                println("You won. Pog. You chose " + playerChoice + ", and the computer chose "
                + RPS[comChoice]);
            } else if (playerChoice.equals("Rock") && RPS[comChoice].equals("Rock")) {
                println("You tied. Kinda mid at this game ngl. You chose " + playerChoice
