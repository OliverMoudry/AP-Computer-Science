...
public class houseProject extends JPanel {
  ...
  public void paintComponent(Graphics g) {
    ...
    g.fillOval(SCREEN_WIDTH/3 + 100, SCREEN_HEIGHT/3 + 50, SCREEN_WIDTH, SCREEN_HEIGHT);
    g.setColor(Color.BLACK);
    ...
    g.setColor(Color.ORANGE.darker().darker().darker());
    drawTriangle(g, SCREEN_WIDTH / 3 - 50, SCREEN_HEIGHT / 3, SCREEN_WIDTH / 3 + 550, SCREEN_HEIGHT / 3, SCREEN_WIDTH / 2,
